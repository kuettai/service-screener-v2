...
class FindingsPageBuilder(CustomPageBuilder):
    ...
    def customPageInit(self):
        ...
        # Excel file should exist at this point (generated by OutputGenerator)
        if not os.path.exists(excel_path):
            from utils.Tools import _warn
            _warn(f"FindingsPageBuilder: workItem.xlsx not found at {excel_path}")
            raise FileNotFoundError(f"workItem.xlsx not found at {excel_path}")
