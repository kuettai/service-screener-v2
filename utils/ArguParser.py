...
class ArguParser:
    ...
    CLI_ARGUMENT_RULES = {
        ...
        "services": {
            ...
            "default": "rds,ec2,iam,s3,efs,lambda,guardduty,cloudfront,cloudtrail,elasticache,eks,dynamodb,opensearch,kms,cloudwatch,redshift,apigateway,sqs,glue,sagemaker,bedrock,stepfunctions,sns,wafv2,cognito,acm,kinesis,firehose,ecr,backup,ecs,route53,secretsmanager,eventbridge,config,ssm,codebuild",
